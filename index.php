      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
            <div class="form-group">
                <input type="text" name="cin" id="cin" class="form-control" placeholder="Email">
              </div>
              <div class="row">
                <div class="col-sm">
                  <div class="form-group">
              ...
              <div class="form-group">
                <input type="email" name="email" id="email0" class="form-control" placeholder="Email">
              </div>
              <div class="form-group">
                <input type="text" name="usernameA" id="usernameA" class="form-control" placeholder="User Name">
              </div>
              <div class="form-group mb-4">
                <input type="password" name="passwordA" id="passwordA" class="form-control" placeholder="***********">
              </div>
            </form>
          </div>
